                ...
                <aside className="w-full md:w-64 space-y-1">
                    {[
                        ...
                        <button
                            ...
                            className={`w-full flex items-center gap-3 px-3 py-2 text-sm font-medium rounded-md transition-colors ${activeTab === item.id ? 'bg-primary/10 text-primary' : 'text-muted-foreground hover:bg-muted'
                                }`}
                        >
                ...
                <div className="flex-1 space-y-6">
                    ...
                    {(activeTab === 'security' || activeTab === 'notifications') && (
                        <div className="flex items-center justify-center h-64 text-muted-foreground">
                            Content for {activeTab} settings coming soon.
                        </div>
                    )}
                </div>
            </div>
