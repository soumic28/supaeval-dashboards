            ...
            <Card>
                ...
                <CardContent>
                    <div className="space-y-1">
                        ...
                        {runs.map((run) => (
                            <div key={run.id} className="flex flex-col md:grid md:grid-cols-7 gap-4 md:gap-0 items-start md:items-center px-4 py-4 hover:bg-muted/50 transition-colors rounded-md border-b border-border/50 last:border-0">
                                ...
                                <div className="col-span-1 w-full md:w-auto flex justify-between md:block">
                                    ...
                                    <span className="text-sm">{run.dataset}</span>
                                </div>
                                <div className="col-span-1 w-full md:w-auto flex justify-between md:block">
