...
>(({ className, ...props }, ref) => (
    <div
        ref={ref}
        className={cn(
            "fixed top-0 z-[100] flex max-h-screen w-full flex-col p-4 sm:right-0 md:max-w-[420px] pointer-events-none",
            className
        )}
        {...props}
    />
...
const Toast = React.forwardRef<
    HTMLDivElement,
    React.HTMLAttributes<HTMLDivElement> & { variant?: "default" | "destructive" | "success"; open?: boolean }
