...
export function EditAgentDialog({
    ...
    const content = (
        ...
        >
            ...
            <div className="py-2 flex-1 overflow-y-auto px-6 scrollbar-thin scrollbar-thumb-border hover:scrollbar-thumb-muted-foreground/20 scrollbar-track-transparent">
